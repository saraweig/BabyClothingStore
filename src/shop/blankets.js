...
import blapic from '../images/website/צילום מסך 2023-12-06 141836.png'
...
export default function Blankets() {
    ...
    return (
        <>
              <img src={blapic} style={{"width":"100%", "height":"330px","display":"block","margin-left": "auto", "margin-right": "auto","marginTop":"50px", "marginBottom":"50px"}}></img>
            <div id="wrap">
