...
import pajpic from '../images/website/צילום מסך 2023-12-06 141930.png'
export default function Pajamas() {
    ...
    return (
        <>
            <img src={pajpic} style={{"width":"100%", "height":"330px","display":"block","margin-left": "auto", "margin-right": "auto","marginTop":"50px", "marginBottom":"50px"}}></img>
            <div id="wrap">
                {outwair.map((item, index) => (
                     (item.id >= 500 && item.id < 600) ? (
