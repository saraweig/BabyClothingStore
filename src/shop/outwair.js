...
import outpic from '../images/website/צילום מסך 2023-12-06 142027.png'

export default function Outwair() {
    ...
    return (
        <>
            <img src={outpic} style={{"width":"100%", "height":"330px","display":"block","margin-left": "auto", "margin-right": "auto","marginTop":"50px", "marginBottom":"50px"}}></img>
            <div id="wrap">
