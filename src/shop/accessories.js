...
import accpic from '../images/website/צילום מסך 2023-12-06 142119.png'
...
export default function Accessories() {
    ...
    return (
        <>
          <img src={accpic} style={{"width":"100%", "height":"330px","display":"block","margin-left": "auto", "margin-right": "auto","marginTop":"50px", "marginBottom":"50px"}}></img>
            <div id="wrap">
                {outwair.map((item, index) => (
                     (item.id >= 400 && item.id < 500) ? (
